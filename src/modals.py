        ...
        try:
            ...
            if not infos:
                await interaction.followup.send(
                    f":warning: {interaction.user.mention} :warning:\n\nThe link to your Geoguessr profile seems to be incorrect. To find it, go to https://www.geoguessr.com/me/profile and click on your profile picture, it'll copy your id to your clipboard. If you think this is a mistake, please contact an admin!",
                    ephemeral=True,
                )
            else:
                member["flag"] = infos[0]
